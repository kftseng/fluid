...
class StandaloneViewTest extends \TYPO3\CMS\Extbase\Tests\Unit\BaseTestCase {
	...
	/**
	 * @var \TYPO3\Fluid\Core\Parser\ParsedTemplateInterface
	 */
	...
	public function objectManagerCallback($className) {
		...
		case 'TYPO3\\Fluid\\Core\\Parser\\TemplateParser':
			return $this->mockTemplateParser;
		case 'TYPO3\\Fluid\\Core\\Rendering\\RenderingContext':
		...
		case 'TYPO3\\Fluid\\Core\\Compiler\\TemplateCompiler':
	...
	public function constructorSetsSpecifiedContentObject() {
		...
		new \TYPO3\Fluid\View\StandaloneView($mockContentObject);
	}
