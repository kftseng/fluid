...
class BooleanNodeTest extends \TYPO3\CMS\Extbase\Tests\Unit\BaseTestCase {
	...
	public function convertToBooleanProperlyConvertsNumericValues() {
		...
		$this->assertFalse(\TYPO3\Fluid\Core\Parser\SyntaxTree\BooleanNode::convertToBoolean('-1'));
		$this->assertFalse(\TYPO3\Fluid\Core\Parser\SyntaxTree\BooleanNode::convertToBoolean(-0.5));
		$this->assertTrue(\TYPO3\Fluid\Core\Parser\SyntaxTree\BooleanNode::convertToBoolean(1));
		$this->assertTrue(\TYPO3\Fluid\Core\Parser\SyntaxTree\BooleanNode::convertToBoolean(0.5));
	}
