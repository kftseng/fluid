...
class TemplateParserPatternTest extends \TYPO3\CMS\Extbase\Tests\Unit\BaseTestCase {
	...
	public function testSCAN_PATTERN_LEGACYNAMESPACEDECLARATION() {
		$pattern = str_replace('FLUID_NAMESPACE_SEPARATOR', preg_quote(\TYPO3\Fluid\Fluid::LEGACY_NAMESPACE_SEPARATOR), \TYPO3\Fluid\Core\Parser\TemplateParser::$SCAN_PATTERN_NAMESPACEDECLARATION);
