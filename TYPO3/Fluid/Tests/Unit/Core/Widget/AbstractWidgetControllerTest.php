...
class AbstractWidgetControllerTest extends \TYPO3\CMS\Extbase\Tests\Unit\BaseTestCase {
	...
	public function canHandleWidgetRequest() {
		$request = $this->getMock('TYPO3\\Fluid\\Core\\Widget\\WidgetRequest', array('dummy'), array(), '', FALSE);
	...
	public function processRequestSetsWidgetConfiguration() {
		...
		$request = $this->getMock('TYPO3\\Fluid\\Core\\Widget\\WidgetRequest', array(), array(), '', FALSE);
	...
	public function viewConfigurationCanBeOverriddenThroughFrameworkConfiguration() {
		$frameworkConfiguration = array(
			'view' => array(
				'widget' => array(
					'TYPO3\\Fluid\\ViewHelpers\\Widget\\PaginateViewHelper' => array(
		...
		$widgetContext = $this->getMock('TYPO3\\Fluid\\Core\\Widget\\WidgetContext');
		$widgetContext->expects($this->any())->method('getWidgetViewHelperClassName')->will($this->returnValue('TYPO3\\Fluid\\ViewHelpers\\Widget\\PaginateViewHelper'));
		$request = $this->getMock('TYPO3\\Fluid\\Core\\Widget\\WidgetRequest', array(), array(), '', FALSE);
		...
		$view = $this->getAccessibleMock('TYPO3\\Fluid\\View\\TemplateView', array('dummy'));
		$abstractWidgetController = $this->getAccessibleMock('TYPO3\\Fluid\\Core\\Widget\\AbstractWidgetController', array('dummy'));
