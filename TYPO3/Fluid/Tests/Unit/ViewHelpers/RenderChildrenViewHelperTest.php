 ...
 */
class RenderChildrenViewHelperTest extends \TYPO3\Fluid\Tests\Unit\ViewHelpers\ViewHelperBaseTestcase {
	...
	public function setUp() {
		...
		$this->viewHelper = $this->getAccessibleMock('TYPO3\\Fluid\\ViewHelpers\\RenderChildrenViewHelper', array('renderChildren'));
	...
	public function renderCallsEvaluateOnTheRootNodeAndRegistersTheArguments() {
		$this->request = $this->getMock('TYPO3\\Fluid\\Core\\Widget\\WidgetRequest');
	...
	/**
	 * @test
	 * @expectedException \TYPO3\Fluid\Core\Widget\Exception\WidgetRequestNotFoundException
	 */
