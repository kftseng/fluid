...
class IfHasRoleViewHelperTest extends \TYPO3\Fluid\Tests\Unit\ViewHelpers\ViewHelperBaseTestcase {
	...
	/**
	 * @var \TYPO3\Fluid\ViewHelpers\Security\IfHasRoleViewHelper
	 */
	...
	public function setUp() {
		...
		$this->viewHelper = $this->getAccessibleMock('TYPO3\\Fluid\\ViewHelpers\\Security\\IfHasRoleViewHelper', array('renderThenChild', 'renderElseChild'));
