 ...
 */
class ForViewHelperTest extends \TYPO3\Fluid\Tests\Unit\ViewHelpers\ViewHelperBaseTestcase {
	...
	public function renderExecutesTheLoopCorrectly() {
		...
		$viewHelperNode = new \TYPO3\Fluid\Tests\Unit\ViewHelpers\Fixtures\ConstraintSyntaxTreeNode($this->templateVariableContainer);
