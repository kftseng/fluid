 ...
 */
class IfHasRoleViewHelperTest extends \TYPO3\Fluid\Tests\Unit\ViewHelpers\ViewHelperBaseTestcase {
	...
	public function setUp() {
		...
		$this->viewHelper = $this->getAccessibleMock('TYPO3\\Fluid\\ViewHelpers\\Be\\Security\\IfHasRoleViewHelper', array('renderThenChild', 'renderElseChild'));
