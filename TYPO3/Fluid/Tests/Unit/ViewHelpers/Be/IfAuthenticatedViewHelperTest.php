<?php
namespace TYPO3\Fluid\Tests\Unit\ViewHelpers\Be;
 ...
 */
class IfAuthenticatedViewHelperTest extends \TYPO3\Fluid\Tests\Unit\ViewHelpers\ViewHelperBaseTestcase {

	/**
	 * @var \TYPO3\Fluid\ViewHelpers\Be\Security\IfAuthenticatedViewHelper
	 */
	...
	public function setUp() {
		...
		$this->viewHelper = $this->getAccessibleMock('TYPO3\\Fluid\\ViewHelpers\\Be\\Security\\IfAuthenticatedViewHelper', array('renderThenChild', 'renderElseChild'));
