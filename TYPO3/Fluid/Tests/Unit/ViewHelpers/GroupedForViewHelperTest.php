 ...
 */
class GroupedForViewHelperTest extends \TYPO3\Fluid\Tests\Unit\ViewHelpers\ViewHelperBaseTestcase {
	...
	public function renderGroupsMultidimensionalArrayByPropertyPath() {
		...
		/** @var \TYPO3\CMS\Core\Tests\AccessibleObjectInterface|\TYPO3\Fluid\ViewHelpers\GroupedForViewHelper $accessibleMock */
		$accessibleMock = $this->getAccessibleMock('TYPO3\\Fluid\\ViewHelpers\\GroupedForViewHelper', array('dummy'));
