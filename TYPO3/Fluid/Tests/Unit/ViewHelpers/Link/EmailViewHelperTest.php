 ...
 */
class EmailViewHelperTest extends \TYPO3\Fluid\Tests\Unit\ViewHelpers\ViewHelperBaseTestcase {
	...
	public function setUp() {
		...
		$this->viewHelper = $this->getMock($this->buildAccessibleProxy('TYPO3\\Fluid\\ViewHelpers\\Link\\EmailViewHelper'), array('renderChildren'));
