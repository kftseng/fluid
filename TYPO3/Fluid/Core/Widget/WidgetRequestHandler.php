...
class WidgetRequestHandler extends \TYPO3\CMS\Extbase\Mvc\Web\AbstractRequestHandler {
	 ...
	 *
	 * @param \TYPO3\Fluid\Core\Widget\WidgetRequestBuilder $requestBuilder
	 * @return void
	 */
	public function injectRequestBuilder(\TYPO3\Fluid\Core\Widget\WidgetRequestBuilder $requestBuilder) {
