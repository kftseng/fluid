...
class Bootstrap {
	...
	public function run($content, $configuration) {
		$this->objectManager = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance('TYPO3\\Fluid\\Object\\ObjectManagerInterface');
		$this->initializeConfiguration($configuration);
		$this->configureObjectManager();
		$ajaxWidgetContextHolder = $this->objectManager->get('TYPO3\\Fluid\\Core\\Widget\\AjaxWidgetContextHolder');
	...
	public function configureObjectManager() {
		$typoScriptSetup = $this->configurationManager->getConfiguration(\TYPO3\Fluid\Configuration\ConfigurationManagerInterface::CONFIGURATION_TYPE_FULL_TYPOSCRIPT);
