...
class TemplateParser {
	...
	protected function resolveViewHelperName($namespaceIdentifier, $methodIdentifier) {
		...
		$namespaceSeperator = strpos($this->namespaces[$namespaceIdentifier], \TYPO3\Fluid\Fluid::NAMESPACE_SEPARATOR) !== FALSE ? \TYPO3\Fluid\Fluid::NAMESPACE_SEPARATOR : \TYPO3\Fluid\Fluid::LEGACY_NAMESPACE_SEPARATOR;
