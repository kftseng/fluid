...
class TemplateVariableContainer implements \ArrayAccess {
	...
	public function __construct($variableArray = array()) {
		if (is_array($variableArray) === TRUE) {
	...
	public function add($identifier, $value) {
		...
		if (in_array(strtolower($identifier), self::$reservedVariableNames)) {
			throw new \TYPO3\Fluid\Core\ViewHelper\Exception\InvalidVariableException('"' . $identifier . '" is a reserved variable name and can\'t be used as variable identifier.', 1256730379);
		}
