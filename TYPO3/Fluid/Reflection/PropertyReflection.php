...
class PropertyReflection extends \ReflectionProperty {
	...
	/**
	 * @var \TYPO3\Fluid\Reflection\DocCommentParser An instance of the doc comment parser
	 */
	...
	public function getValue($object = NULL) {
		if (!is_object($object)) {
			throw new \TYPO3\Fluid\Reflection\Exception('$object is of type ' . gettype($object) . ', instance of class ' . $this->class . ' expected.', 1210859212);
		}
		if ($this->isPublic()) {
			return parent::getValue($object);
		}
		if ($this->isPrivate()) {
			throw new \TYPO3\Fluid\Reflection\Exception('Cannot return value of private property "' . $this->name . '.', 1210859206);
		}
