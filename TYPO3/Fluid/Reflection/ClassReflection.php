...
class ClassReflection extends \ReflectionClass {
	...
	/**
	 * @var \TYPO3\Fluid\Reflection\DocCommentParser Holds an instance of the doc comment parser for this class
	 */
	 ...
	 * @return \TYPO3\Fluid\Reflection\MethodReflection Method reflection objects of the methods in this class
	 */
	public function getMethods($filter = NULL) {
		$extendedMethods = array();
		$methods = $filter === NULL ? parent::getMethods() : parent::getMethods($filter);
		foreach ($methods as $method) {
			$extendedMethods[] = new \TYPO3\Fluid\Reflection\MethodReflection($this->getName(), $method->getName());
		}
	 ...
	 *
	 * @param string $name
	 * @return \TYPO3\Fluid\Reflection\MethodReflection Method reflection object of the named method
	 */
	public function getMethod($name) {
		...
		return new \TYPO3\Fluid\Reflection\MethodReflection($this->getName(), $parentMethod->getName());
	}
	...
	public function getConstructor() {
		...
		return new \TYPO3\Fluid\Reflection\MethodReflection($this->getName(), $parentConstructor->getName());
	}
	...
	public function getProperties($filter = NULL) {
		...
		foreach ($properties as $property) {
			$extendedProperties[] = new \TYPO3\Fluid\Reflection\PropertyReflection($this->getName(), $property->getName());
		}
	 ...
	 * @return \TYPO3\Fluid\Reflection\PropertyReflection Property reflection object of the specified property in this class
	 */
	public function getProperty($name) {
		return new \TYPO3\Fluid\Reflection\PropertyReflection($this->getName(), $name);
	}
	...
	public function getInterfaces() {
		...
		foreach ($interfaces as $interface) {
			$extendedInterfaces[] = new \TYPO3\Fluid\Reflection\ClassReflection($interface->getName());
		}
	...
	public function getParentClass() {
		...
		return $parentClass === FALSE ? FALSE : new \TYPO3\Fluid\Reflection\ClassReflection($parentClass->getName());
	}
	 ...
	 *
	 * @return \TYPO3\Fluid\Reflection\DocCommentParser
	 */
	protected function getDocCommentParser() {
		if (!is_object($this->docCommentParser)) {
			$this->docCommentParser = new \TYPO3\Fluid\Reflection\DocCommentParser();
