...
class RenderChildrenViewHelper extends \TYPO3\Fluid\Core\ViewHelper\AbstractViewHelper {
	...
	protected function getWidgetContext() {
		...
		if (!$request instanceof \TYPO3\Fluid\Core\Widget\WidgetRequest) {
			throw new \TYPO3\Fluid\Core\Widget\Exception\WidgetRequestNotFoundException('The Request is not a WidgetRequest! <f:renderChildren> must be called inside a Widget Template.', 1284986120);
		}
