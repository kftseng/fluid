...
class PaginateViewHelper extends \TYPO3\Fluid\Core\Widget\AbstractWidgetViewHelper {
	...
	/**
	 * @param \TYPO3\Fluid\ViewHelpers\Widget\Controller\PaginateController $controller
	 * @return void
	 */
	public function injectController(\TYPO3\Fluid\ViewHelpers\Widget\Controller\PaginateController $controller) {
